...
class SeamCarver:
    def __init__(self, img):
        ...
        self.out_height = min(self.in_height, self.in_width)
        self.out_width = min(self.in_height, self.in_width)
    ...
    def save_result(self):
        return self.out_image.astype(np.uint8)
    
    def save_result2(self, filename):
